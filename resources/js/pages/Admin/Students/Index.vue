          ...
          <div class="col-md-5 col-12 mb-2">
            <div class="row">
              <div class="col-md-6 col-12 mb-2">
                <Link href="/admin/students/create" class="btn btn-md btn-primary w-100 border-0 shadow" type="button"
                  ><i class="fa fa-plus-circle"></i> Tambah</Link
                >
              </div>
              <div class="col-md-6 col-12 mb-2">
                <Link href="/admin/students/import" class="btn btn-md btn-success w-100 border-0 text-white shadow" type="button"
                ...
                <tbody>
                  <tr v-for="(student, index) in students.data" :key="index">
                    ...
                    <td class="text-center">
                      <Link :href="`/admin/students/${student.id}/edit`" class="btn btn-sm btn-info me-2 border-0 shadow" type="button"
