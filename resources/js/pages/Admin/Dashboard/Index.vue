<template>
  ...
  <div class="container-fluid mt-5 mb-5">
    <div class="row">
      <div class="col-sm-6 col-xl-3 col-12 mb-4">
        <div class="card border-0 shadow">
          <div class="card-body">
            <div class="row d-block d-xl-flex align-items-center">
              <div class="col-xl-5 text-xl-center mb-xl-0 d-flex align-items-center justify-content-xl-center col-12 mb-3">
                <div class="icon-shape icon-shape-info me-sm-0 me-4 rounded">
              ...
              <div class="col-xl-7 px-xl-0 col-12">
      ...
      <div class="col-sm-6 col-xl-3 col-12 mb-4">
        <div class="card border-0 shadow">
          <div class="card-body">
            <div class="row d-block d-xl-flex align-items-center">
              <div class="col-xl-5 text-xl-center mb-xl-0 d-flex align-items-center justify-content-xl-center col-12 mb-3">
                <div class="icon-shape icon-shape-success me-sm-0 me-4 rounded">
      ...
      <div class="col-sm-6 col-xl-3 col-12 mb-4">
        <div class="card border-0 shadow">
          <div class="card-body">
            <div class="row d-block d-xl-flex align-items-center">
              <div class="col-xl-5 text-xl-center mb-xl-0 d-flex align-items-center justify-content-xl-center col-12 mb-3">
                <div class="icon-shape icon-shape-danger me-sm-0 me-4 rounded">
